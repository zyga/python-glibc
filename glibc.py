...
_glibc_constants = (
    ...
    ('CLD_EXITED', c_int(1), ('signal.h',)),
    ('CLD_KILLED', c_int(2), ('signal.h',)),
    ('CLD_DUMPED', c_int(3), ('signal.h',)),
    ('CLD_TRAPPED', c_int(5), ('signal.h',)),
    ('CLD_STOPPED', c_int(6), ('signal.h',)),
    ('CLD_CONTINUED', c_int(7), ('signal.h',)),
    ...
    ('EPOLLIN',    c_uint(0x0001), ()),
    ('EPOLLOUT',   c_uint(0x0004), ()),
    ('EPOLLRDHUP', c_uint(0x2000), ()),
    ('EPOLLPRI',   c_uint(0x002), ()),
    ('EPOLLERR',   c_uint(0x008), ()),
    ('EPOLLHUP',   c_uint(0x010), ()),
    ('EPOLLET',    c_uint(1 << 31), ()),
